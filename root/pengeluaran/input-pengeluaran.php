...
<html lang="en" data-bs-theme="auto">
	<head>
		...
		<title>Input Pengeluaran | Avalon it's Online</title>
	...
	<body>
				...
				<div class="offcanvas-md offcanvas-end" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
					...
					<div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3">
						<ul class="nav flex-column">
							...
							<li class="nav-item">
								<a class="nav-link d-flex align-items-center gap-2 active" href="../pengeluaran/">
		...
		<main class="col-md-9 ms-sm-auto col-lg-10 px-md-5">
			<div class="row">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
					<h3 style="color:#373435">Input Pengeluaran - Avalon</h3>
				</div>
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="container">
						<a href="#" class="btn btn-secondary mb-3" onclick="goBack()">< Data Pengeluaran</a>
						<div class="card" style="background-color: white;border-color: black;">
							<div class="card-body p-0 m-2">
								<div class=" table-wrapper table-responsive">
									<form class="m-4" autocomplete="off" action="simpan-pengeluaran" onsubmit="return cek_dulu();" method="POST" enctype="multipart/form-data">								
										<div class="form-floating mb-3">
											<select class="form-control" onchange="pindah()" id="kategori_pengeluaran" name="kategori_pengeluaran" autofocus>
												<option value="0">Pilih Kategori Pengeluaran</option>
												<option value="GAJI">Gaji</option>
												<option value="PEMBAYARAN TAGIHAN BULANAN">Pembayaran Tagihan Bulanan</option>
										...
										<div class="form-floating mb-3">
											<textarea class="form-control" placeholder="" id="keterangan_pengeluaran" name="keterangan_pengeluaran"></textarea>
											<label for="keterangan_pengeluaran">Keterangan</label>
										</div>

										<div class="form-floating mb-3">
											<input type="text" class="form-control" id="untuk_pengeluaran" name="untuk_pengeluaran" placeholder=""  >
											<label for="untuk_pengeluaran">Diajukan Oleh</label>
										</div>

										<div class="form-floating mb-3">											
											<input type="text" autofocus class="form-control mata-uang" onkeyup="inputTerbilang()" name="nominal_pengeluaran" id="nominal_pengeluaran" placeholder="">
											</input>
											<label for="nominal_pengeluaran">Nominal Pengeluaran (Rp)</label>
										</div>
		...
		<script src="../../assets/dist/js/terbilang.js"></script>
		...
		<script>
			...
			function pindah(){
				var ob_keterangan_pengeluaran = document.getElementById("keterangan_pengeluaran");
				ob_keterangan_pengeluaran.focus();	
			}

			function cek_dulu(){
				
				
				var s_kategori_pengeluaran = document.getElementById("kategori_pengeluaran").value;
				var s_keterangan_pengeluaran = document.getElementById("keterangan_pengeluaran").value;
				var s_untuk_pengeluaran = document.getElementById("untuk_pengeluaran").value;
				var s_nominal_pengeluaran = document.getElementById("nominal_pengeluaran").value;
				

				var ob_kategori_pengeluaran = document.getElementById("kategori_pengeluaran");
				var ob_keterangan_pengeluaran = document.getElementById("keterangan_pengeluaran");
				var ob_untuk_pengeluaran = document.getElementById("untuk_pengeluaran");
				var ob_nominal_pengeluaran = document.getElementById("nominal_pengeluaran");
				
								
				if (s_kategori_pengeluaran == "0"){
					alert('Pilih Kategori terlebih dahulu.');
					ob_kategori_pengeluaran.focus();
					return false;
				}
				else if (s_keterangan_pengeluaran==''){
					alert('Isi Keterangan terlebih dahulu');
					ob_keterangan_pengeluaran.focus();
					return false;
				}
				else if (s_untuk_pengeluaran==''){
					alert('Isi diajukan oleh terlebih dahulu');
					ob_untuk_pengeluaran.focus();
					return false;
				}
				else if (s_nominal_pengeluaran==''){
					alert('Isi Nominal terlebih dahulu');
					ob_nominal_pengeluaran.focus();
					return false;
				}
				else{        
					return true;
