...
<html moznomarginboxes mozdisallowselectionprint>
	...
	<body>
		...
		<h3 style="color:#373435" class="left"><u>Summary Avalon</u></h3>
		...
		<p><br>
			<?php
				...
				$t_utang = mysqli_query($koneksi, "SELECT sum(NOMINAL) as tot_utang FROM tbl_pengeluaran WHERE TGL_DIBUAT BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."' AND KATEGORI='UTANG'");
				while ($dd = mysqli_fetch_array($t_utang)) {
					$tot_utang = $dd['tot_utang'];					
				}
				
				$bayar_utang = mysqli_query($koneksi, "SELECT sum(NOMINAL) as bu_bu FROM tbl_pemasukan WHERE TGL_DIBUAT BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."' AND KATEGORI='PEMBAYARAN UTANG'");
		...
		<table class="border-0 text-left" style="width: 80%">
			<tr>
				<td>
					<p style="color:#373435" class="left">Total Profit</p>
				</td>
				<td style="width: 5%">
					<p style="color:#373435" class="center">:</p>
				</td>
				<td style="width: 70%">
					<p style="color:#373435" class="left"><b><?php echo $keuntungan_tamp; ?></b></p>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td style="width: 70%">
					<p style="color:#373435" class="left"><b><?php echo $total_utang_tamp; ?></b></p>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td style="width: 70%">
					<p style="color:#373435" class="left"><b><?php echo $tot_pemasukan_tamp; ?></b></p>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td style="width: 70%">
					<p style="color:#373435" class="left"><b><?php echo $tot_pengeluaran_tamp; ?></b></p>
				</td>
			</tr>
			<tr>
				<td colspan="2">
		...
		<div class="container-xxl mb-5">
			<table class="table center m-0" style="width: 100%">
				<tr class='text-center' style="background-color:#7EEC7A">
					<th colspan="5">
						<p style="font-size:1.3rem;color:#373435">DETAIL PEMASUKAN</p>
					</th>
				</tr>
				...
				<tr>
					...
					<td class="text-start"><p style="font-size:0.8rem ;"><?php echo $tgl_buat; ?></p></td>
		...
		<div class="container-xxl mt-5">
			<table class="table center m-0" style="width: 100%">
				<tr class='text-center' style="background-color:#7EEC7A">
					<th colspan="5">
						<p style="font-size:1.3rem;color:#373435">DETAIL PENGELUARAN</p>
					</th>
				</tr>
				<tr class="text-center">
					<td style="width: 5%;"><b>No</b></td>
				...
				<tr>
					...
					<td class="text-center"><?php echo $kategori; ?></td>
					<td class="text-start"><?php echo $keterangan; ?></td>
					<td class="text-start"><?php echo $untuk; ?></td>								
					<td class="text-end"><?php echo "Rp".$nominal; ?></td>								
					<?php $no++; }
					?>
				</tr>
