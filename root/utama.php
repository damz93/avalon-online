...
<html lang="en" data-bs-theme="auto">
	<head>
		...
		<title>Halaman Utama | Avalon it's Online</title>
	...
	<body>
		...
		<div class="container-fluid">
					...
					<div class="offcanvas-md offcanvas-end" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
						...
						<div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3">
							<ul class="nav flex-column">
								<li class="nav-item">
									<a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="utama">
			...
			<?php
				...
				$bulan_ini = date('M-Y');
				$pemasukan_bulan = mysqli_query($koneksi, "SELECT sum(NOMINAL) as pem_bul FROM tbl_pemasukan WHERE YEAR(TGL_DIBUAT)='$tahun_cek' and MONTH(TGL_DIBUAT)='$bulan_cek' ");
				while ($dd = mysqli_fetch_array($pemasukan_bulan)) {
					$pem_bul = $dd['pem_bul'];
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-5">
				<div class="row">
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
						<h3 style="color:#373435">Welcome Back, <?php echo $nama; ?></h3>
						<p style="font-size:12px;text-align:right;color:#373435" class="mt-2">
					...
					<div class="col-lg-3 mt-3">
						<div class="service-box">
							<div class="service-content">
								<p style="font-size:12pt;color:#fcfcfc" class="text-center">Hutang Bulan Ini<br>(<?php echo $bulan_ini; ?>)
								</p>
							</div>
					...
					<div class="col-lg-3 mt-3">
						<div class="service-box">
							<div class="service-content">
								<p style="font-size:12pt;color:#fcfcfc" class="text-center">Pemasukan Bulan Ini<br>(<?php echo $bulan_ini; ?>)
								</p>
							</div>
					...
					<div class="col-lg-3 mt-3">
						<div class="service-box">
							<div class="service-content">
								<p style="font-size:12pt;color:#fcfcfc" class="text-center">Pengeluaran Bulan Ini<br>(<?php echo $bulan_ini; ?>)
								</p>
							</div>
