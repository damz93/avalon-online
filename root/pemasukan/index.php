...
<html lang="en" data-bs-theme="auto">
	<head>
		...
		<title>Data Pemasukan | Avalon it's Online</title>
	...
	<body>
		...
		<main class="col-md-9 ms-sm-auto col-lg-10 px-md-5">
			...
			<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
				<h3 style="color:#373435">Data Pemasukan - Avalon</h3>
			</div>
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="container">
					<a href="input-pemasukan" class="btn btn-success mb-3">+ Pemasukan</a>
							...
							<div class="card-body">
								<table id="tabel1" class="table table-hover border"  cellpadding="0" cellspacing="1">
									...
									<?php 
										...
										$no=1;
										$data = mysqli_query($koneksi,"select * from tbl_pemasukan order by ID DESC");
									...
									<tr class="center">
										...
										<td class="text-center">
											<a href='hapus-pemasukan.php?id=<?php echo $d['ID']; ?>' title="Hapus Pemasukan" onclick="return confirm('Yakin Ingin Hapus?')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-square" viewBox="0 0 16 16"><path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/><path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg></a>
										</td>
										<!-- <td>			
