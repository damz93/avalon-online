...
<html lang="en" data-bs-theme="auto">
	<head>
		...
		<title>Input Pemasukan | Avalon it's Online</title>
	...
	<body>
				...
				<div class="offcanvas-md offcanvas-end" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
					...
					<div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3">
						<ul class="nav flex-column">
							...
							<li class="nav-item">
								<a class="nav-link d-flex align-items-center gap-2 active" href="../pemasukan/">
		...
		<main class="col-md-9 ms-sm-auto col-lg-10 px-md-5">
			<div class="row">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
					<h3 style="color:#373435">Input Pemasukan - Avalon</h3>
				</div>
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="container">
						<a href="#" class="btn btn-secondary mb-3" onclick="goBack()">< Data Pemasukan</a>
						<div class="card" style="background-color: white;border-color: black;">
							<div class="card-body p-0 m-2">
								<div class=" table-wrapper table-responsive">
									<form class="m-4" autocomplete="off" action="simpan-pemasukan" onsubmit="return cek_dulu();" method="POST" enctype="multipart/form-data">								
										...
										<div class="form-floating mb-3">
											<textarea class="form-control" id="keterangan_pemasukan" name="keterangan_pemasukan" placeholder=""></textarea>
											<label for="keterangan_pemasukan">Keterangan</label>
										</div>
										<div class="form-floating mb-3">											
											<input type="text" autofocus class="form-control mata-uang" onkeyup="inputTerbilang()" name="nominal_pemasukan" id="nominal_pemasukan" placeholder="">
											</input>
											<label for="nominal_pemasukan">Nominal Pemasukan (Rp)</label>
										</div>
		...
		<script>
			...
			function pindah(){
				var ob_keterangan_pemasukan = document.getElementById("keterangan_pemasukan");
				ob_keterangan_pemasukan.focus();	
			}

			function cek_dulu(){
				
				
				var s_kategori_pemasukan = document.getElementById("kategori_pemasukan").value;
				var s_keterangan_pemasukan = document.getElementById("keterangan_pemasukan").value;
				var s_nominal_pemasukan = document.getElementById("nominal_pemasukan").value;
				

				var ob_kategori_pemasukan = document.getElementById("kategori_pemasukan");
				var ob_keterangan_pemasukan = document.getElementById("keterangan_pemasukan");
				var ob_nominal_pemasukan = document.getElementById("nominal_pemasukan");
				
								
				if (s_kategori_pemasukan == "0"){
					alert('Pilih Kategori terlebih dahulu.');
					ob_kategori_pemasukan.focus();
					return false;
				}
				else if (s_keterangan_pemasukan==''){
					alert('Isi Keterangan terlebih dahulu');
					ob_keterangan_pemasukan.focus();
					return false;
				}
				else if (s_nominal_pemasukan==''){
					alert('Isi Nominal terlebih dahulu');
					ob_nominal_pemasukan.focus();
					return false;
				}
				else{        
					return true;
