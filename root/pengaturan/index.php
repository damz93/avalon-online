...
<html lang="en" data-bs-theme="auto">
	<head>
		...
		<title>Pengaturan | Avalon it's Online</title>
	...
	<body>
			...
			<div class="sidebar col-md-3 col-lg-2 p-0 bg-light">
				...
				<div class="offcanvas-md offcanvas-end" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
					...
					<div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3">
						...
						<ul class="nav flex-column">
							<li class="nav-item">
								<a class="nav-link d-flex align-items-center gap-2 active" href="../pengaturan/">
		...
		<main class="col-md-9 ms-sm-auto col-lg-10 px-md-5">
			...
			<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
				<h3 style="color:#373435">Pengaturan Password - Avalon</h3>
			</div>
				...
				<div class="container">
					...
					<div class="table-wrapper table-responsive">
						<div class="card p-3" style="background-color: white;border-color: black;">
							<div class="card-body">
							<div class=" table-wrapper table-responsive">
									<form class="m-4" autocomplete="off" action="update-password" onsubmit="return cek_dulu();" method="POST" enctype="multipart form-data">																		
										<div class="form-floating mb-3">
											<input style="background-color: white;color:#373435" type="password" class="form-control" id="password_lama" name="password_lama" placeholder="" autofocus >
											<label for="password_lama">Password Lama</label>
										</div>																		
										<div class="form-floating mb-3">
											<input style="background-color: white;color:#373435" type="password" class="form-control" id="password_baru" name="password_baru" placeholder=""  >
											<label for="password_baru">Password Baru</label>
										</div>																	
										<div class="form-floating mb-3">
											<input style="background-color: white;color:#373435" type="password" class="form-control" id="password_baru_lagi" name="password_baru_lagi" placeholder=""  >
											<label for="password_baru_lagi">Ulangi Password Baru</label>
										</div>
		...
		<script>
			function cek_dulu(){
				...
				var s_password_lama = document.getElementById("password_lama").value;
				var s_password_baru = document.getElementById("password_baru").value;
				var s_password_baru_lagi = document.getElementById("password_baru_lagi").value;
				

				
				var ob_password_lama = document.getElementById("password_lama");
				var ob_password_baru = document.getElementById("password_baru");
				var ob_password_baru_lagi = document.getElementById("password_baru_lagi");
				
				if (s_password_lama==''){
					alert('Isi Password Lama terlebih dahulu');
					ob_password_lama.focus();
					return false;
				}
				else if (s_password_baru==''){
					alert('Isi Password Baru terlebih dahulu');
					ob_password_baru.focus();
					return false;
				}
				else if (s_password_baru_lagi==''){
					alert('Isi Password Baru terlebih dahulu');
					ob_password_baru_lagi.focus();
					return false;
				}
				
				else if (s_password_baru!=s_password_baru_lagi){
